...
min_df = pd.read_csv('Training_Data/mindf_filt_glass_clean.csv')
...
# names = ["ae_256_64_16_test1", "ae_256_64_16_test2", "ae_256_64_16_test3", "ae_256_64_16_test4", "ae_256_64_16_test5",
#          "ae_256_64_16_test6", "ae_256_64_16_test7", "ae_256_64_16_test8", "ae_256_64_16_test9", "ae_256_64_16_test10", 
#          "ae_64_16_4_test", "ae_128_32_8_test", 'ae_256_32_8_test']
# nodes_list = [(256, 64, 16), (256, 64, 16), (256, 64, 16), (256, 64, 16), (256, 64, 16),
#               (256, 64, 16), (256, 64, 16), (256, 64, 16), (256, 64, 16), (256, 64, 16),
#               (64, 16, 4), (128, 32, 8), (256, 32, 8)]

names = ["ae_1028_256_64_16_test1"]
nodes_list = [(1028, 256, 64, 16)]

for i in range(len(names)): 
    start_time = time.time()
    print("starting " + str(names[i]))
    z = mm.autoencode(min_df, names[i], mm.Tanh_Autoencoder, nodes_list[i], 200) # (512, 128, 32, 8)
