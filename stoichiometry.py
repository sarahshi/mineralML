...
def calculate_clinopyroxene_components(cpx_comps):
   ...
   Parameters
    ...
    cpx_calc['Cpx_Cation_Sum'] = (cpx_calc['Si_Cpx_cat_6ox'] + cpx_calc['Ti_Cpx_cat_6ox']
    ...
    Ca_CaTs_CaTi_CrCaTs=(cpx_calc['Ca_Cpx_cat_6ox'] - cpx_calc['CaTs_Cpx'] -
                cpx_calc['CaTi_Cpx'] - cpx_calc['CrCaTs_Cpx'])

    cpx_calc['DiHd_Cpx_1996']= (cpx_calc['Ca_Cpx_cat_6ox'] - cpx_calc['CaTs_Cpx']
                - cpx_calc['CaTi_Cpx'] - cpx_calc['CrCaTs_Cpx'] )
    ...
    cpx_calc['EnFs_Cpx'] = ((cpx_calc['Fet_Cpx_cat_6ox'] +
                        cpx_calc['Mg_Cpx_cat_6ox']) - cpx_calc['DiHd_Cpx_1996']) / 2
    cpx_calc['DiHd_Cpx_2003'] = (cpx_calc['Ca_Cpx_cat_6ox'] -
                             cpx_calc['CaTs_Cpx'] - cpx_calc['CaTi_Cpx'] - cpx_calc['CrCaTs_Cpx'])
    cpx_calc['Di_Cpx'] = cpx_calc['DiHd_Cpx_2003'] * (cpx_calc['Mg_Cpx_cat_6ox'] / (
...
# Measured Kd Fe-Mg using Fet
    ...
    combo_liq_cpxs['lnK_Jd_liq'] = np.log((combo_liq_cpxs['Jd_Cpx'].astype(float)) / ((combo_liq_cpxs['Na_Liq_cat_frac']) * (
        combo_liq_cpxs['Al_Liq_cat_frac']) * ((combo_liq_cpxs['Si_Liq_cat_frac'])**2)))

    combo_liq_cpxs['lnK_Jd_DiHd_liq_1996'] = np.log((combo_liq_cpxs['Jd_Cpx'].astype(float))
    * (combo_liq_cpxs['Ca_Liq_cat_frac'].astype(float)) * ((combo_liq_cpxs['Fet_Liq_cat_frac'].astype(float)) + (
        combo_liq_cpxs['Mg_Liq_cat_frac'].astype(float))) / ((combo_liq_cpxs['DiHd_Cpx_1996'].astype(float)) * (combo_liq_cpxs['Na_Liq_cat_frac'].astype(float)) * (combo_liq_cpxs['Al_Liq_cat_frac'].astype(float))))

    combo_liq_cpxs['lnK_Jd_DiHd_liq_2003'] = np.log((combo_liq_cpxs['Jd_Cpx'].astype(float)) * (combo_liq_cpxs['Ca_Liq_cat_frac'].astype(float)) * ((combo_liq_cpxs['Fet_Liq_cat_frac'].astype(float)) + (
...
def calculate_orthopyroxene_components(opx_comps):
   ...
   Parameters
    ...
    opx_calc['Opx_Cation_Sum'] = (opx_calc['Si_Opx_cat_6ox'] + opx_calc['Ti_Opx_cat_6ox']
...
def calculate_23oxygens_amphibole(amp_comps):
   ...
   Parameters
    ...
    cation_23['Amp_Cation_Sum'] = cation_23['cation_sum_Si_Ca'] + \
...
def get_amp_sites_leake(amp_apfu_df):
    ...
    Al_Ti_Cr_Mg_Fe_Mn_less5=(norm_cations['Al_C_Amp']+norm_cations['Ti_Amp_cat_23ox']+norm_cations['Fet_Amp_cat_23ox']
    ...
    Al_Ti_Cr_Mg_Fe_Mn_more5=(norm_cations['Al_C_Amp']+norm_cations['Ti_Amp_cat_23ox']+norm_cations['Fet_Amp_cat_23ox']
    +norm_cations['Cr_Amp_cat_23ox']+norm_cations['Mn_Amp_cat_23ox']+norm_cations['Mg_Amp_cat_23ox'])>5
    ...
    norm_cations['Sum_C']=(norm_cations['Al_C_Amp']+norm_cations['Cr_C_Amp']+norm_cations['Mg_C_Amp']
    +norm_cations['Fe_C_Amp']+norm_cations['Mn_C_Amp'])
    norm_cations['Sum_B']=(norm_cations['Mg_B_Amp']+norm_cations['Fe_B_Amp']+norm_cations['Mn_B_Amp']
    +norm_cations['Ca_B_Amp']+norm_cations['Na_B_Amp'])
    norm_cations['Sum_A']=norm_cations['K_A_Amp']+norm_cations['Na_A_Amp']

    norm_cations['Amp_Cation_Sum'] = norm_cations['cation_sum_Si_Ca'] + \
...
def amp_components_ferric_ferrous(sites_df, norm_cations):
    ...
    f3 = 15 / (sites_df.sum(axis='columns') -
               (sites_df['Na_B_Amp'] + sites_df['Na_A_Amp']) - sites_df['K_A_Amp'] + sites_df['Mn_C_Amp'])
    ...
    f9 = 36 / (46 - (sites_df['Al_T_Amp'] + sites_df['Al_C_Amp']
                     ) - sites_df['Si_T'] - sites_df['Ti_C_Amp'])
...
def amp_components_ferric_ferrous_mutch(sites_df, norm_cations):
    ...
    f3 = 15 / (sites_df.sum(axis='columns') -
               sites_df['K_A_Amp'] - (sites_df['Na_A_Amp'] + sites_df['Na_B_Amp']) + sites_df['Mn_B_Amp'])
    ...
    f6 = 8 / (sites_df['Si_T'] + sites_df['Al_T_Amp'] + sites_df['Al_C_Amp'])
    f7 = 15 / (sites_df.sum(axis='columns') - sites_df['K_A_Amp'])
    f8 = 12.9 / (sites_df.sum(axis='columns') - (sites_df['Na_A_Amp'] + sites_df['K_A_Amp'] +
                                                 sites_df['K_A_Amp']) - sites_df['Ca_B_Amp'] - (sites_df['Mn_C_Amp'] + sites_df['Mn_B_Amp']))
    f8 = (13 / (sites_df.sum(axis='columns') - (sites_df['K_A_Amp'] + sites_df['Na_A_Amp'] + sites_df['Na_B_Amp'])
                - (sites_df['Mn_B_Amp'] + sites_df['Mn_C_Amp']) - sites_df['Ca_B_Amp']))
...
def get_amp_sites_ferric_ferrous_mutch(amp_apfu_df):
    ...
    sites_df = pd.DataFrame(site_vals.T, columns=['Si_T', 'Al_T_Amp', 'Al_C_Amp', 'Ti_C_Amp',
     'Mg_C_Amp', 'Fe3_C', 'Fe2_C', 'Mn_C_Amp', 'Cr_C_Amp', 'Mg_B_Amp', 'Fe2_B', 'Mn_B_Amp', 'Na_B_Amp', 'Ca_B_Amp', 'Na_A_Amp', 'K_A_Amp'],
    index=amp_apfu_df.index)
