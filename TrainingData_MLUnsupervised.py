...
models = (svm.SVC(kernel="linear", C=C),
    ...
    svm.SVC(kernel="rbf", gamma=1e-4, C=C),
...
labels, centers = cluster(z, 20, 'k_means', plot = False, plot_return = False, elements = None, df_shape = None)
...
neuralnetwork(min_df, 'testing', (256, 64, 16))
