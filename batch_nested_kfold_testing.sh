...
#----- Specify your job name (without space). This appears in the notification mails:
...
my_srun="srun --export=all --exclusive -n1 --cpus-per-task=2"
$my_parallel "$my_srun python TrainingData_MLUnsupervised_testing.py" ::: {1..2}
